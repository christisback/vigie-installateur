param(
  ...
  [string]$ServiceName = "VigieBillets"
)
...
# sinon un installateur de mise à jour ne peut plus remplacer brand\favicon-32.png
...
function Update-Status {
  if (Get-ServerRunning) {
    $notifyIcon.Icon = $iconColor
    $notifyIcon.Text = "Vigie Billets - en cours"
  } else {
    $notifyIcon.Icon = $iconGrey
    $notifyIcon.Text = "Vigie Billets - arrêté"
  }
}
...
$openItem = $menu.Items.Add("Ouvrir Vigie Billets")
...
$restartItem.Add_Click({
  ...
  Update-Status
  $notifyIcon.ShowBalloonTip(3000, "Vigie Billets", "Le serveur redémarre...", [System.Windows.Forms.ToolTipIcon]::Info)
})
...
$stopItem.Add_Click({
  ...
  Start-Sleep -Seconds 2
  Update-Status
  $notifyIcon.ShowBalloonTip(3000, "Vigie Billets", "Le serveur a été arrêté.", [System.Windows.Forms.ToolTipIcon]::Warning)
})
...
$startItem.Add_Click({
  ...
  Start-Sleep -Seconds 2
  Update-Status
  $notifyIcon.ShowBalloonTip(3000, "Vigie Billets", "Le serveur démarre...", [System.Windows.Forms.ToolTipIcon]::Info)
})
...
$quitItem.Add_Click({
  $confirm = [System.Windows.Forms.MessageBox]::Show(
    ...
    "Vigie Billets", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
  ...
  try {
    ...
    $notifyIcon.ShowBalloonTip(3000, "Vigie Billets", "Le serveur n'a pas été arrêté (autorisation refusée).", [System.Windows.Forms.ToolTipIcon]::Warning)
    return
  }
...
$notifyIcon.Add_MouseDoubleClick({ Start-Process "http://localhost:3500" })
