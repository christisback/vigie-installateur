...
; ----------------------------------------------------------------------------
; Met à jour Vigie Billets, Vigie Parc et Vigie Inventory en une seule
; exécution. Ne fait JAMAIS de première installation — un programme non
; détecté sur ce poste est simplement ignoré (voir InitializeSetup).
;
...
begin
  ...
  if N = 0 then
  begin
    MsgBox('Aucun des programmes Vigie Billets / Vigie Parc / Vigie Inventory n''a été détecté sur ce poste.' + #13#10#13#10 +
