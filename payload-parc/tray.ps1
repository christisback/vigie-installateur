...
$openItem = $menu.Items.Add("Ouvrir Vigie Parc")
$openItem.Add_Click({ Start-Process "http://localhost:3501" })
...
$restartItem.Add_Click({
  ...
  Update-Status
  $notifyIcon.ShowBalloonTip(3000, "Vigie Parc", "Le serveur redémarre...", [System.Windows.Forms.ToolTipIcon]::Info)
})
...
$stopItem.Add_Click({
  ...
  Start-Sleep -Seconds 2
  Update-Status
  $notifyIcon.ShowBalloonTip(3000, "Vigie Parc", "Le serveur a été arrêté.", [System.Windows.Forms.ToolTipIcon]::Warning)
})
...
$startItem.Add_Click({
  ...
  Start-Sleep -Seconds 2
  Update-Status
  $notifyIcon.ShowBalloonTip(3000, "Vigie Parc", "Le serveur démarre...", [System.Windows.Forms.ToolTipIcon]::Info)
})
...
$quitItem.Add_Click({
  ...
  try {
    ...
    $notifyIcon.ShowBalloonTip(3000, "Vigie Parc", "Le serveur n'a pas été arrêté (autorisation refusée).", [System.Windows.Forms.ToolTipIcon]::Warning)
    return
  }
...
$notifyIcon.Add_MouseDoubleClick({ Start-Process "http://localhost:3501" })
